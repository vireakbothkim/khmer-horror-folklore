...
export const entriesKh = [
  {
    id: 1,
    title: "អាប",
    appearance: "លេចឡើងជាក្បាលស្ត្រី ដែលមានសរីរាង្គខាងក្នុង (បេះដូង សួត និងពោះវៀន) យោលទៅមក និងមានពន្លឺក្រហម។ មានភ្នែកមុតស្រួច បេះដូងលោតភ្លឹបភ្លែតៗដោយពន្លឺក្រហម និងសក់វែងអណ្តែតតាមខ្យល់រាត្រី។",
    story: "អាប គឺជាបណ្តាសាអព្ភូតហេតុបែបប៉ារ៉ាស៊ីតដែលតោងភ្ជាប់ជាមួយម្ចាស់។ វាត្រូវការរាងកាយមនុស្សស្រីដើម្បីរស់ និងប្រមាញ់ ដែលជាទូទៅត្រូវបានផ្ទេរតាមតំណពូជ ឬតាមរយៈការច្រឡំលេបមន្តអាគម ឬទឹកមាត់ដែលត្រូវបណ្តាសា។ នៅពេលយប់ ក្បាលនឹងផ្តាច់ចេញពីរាងកាយដើម្បីស្វែងរកចំណី។ វាល្បីខាងស៊ីឈាម និងសរីរាង្គសត្វពាហនៈដោយបន្សល់ទុកនូវទ្រុងមាន់ស្រោចឈាម និងត្រូវបានគេភ័យខ្លាចយ៉ាងខ្លាំងដោយសារតែវាចូលចិត្តស៊ីឈាម និងសរីរាង្គរបស់ទារកទើបនឹងកើត ឬស្រ្តីមានផ្ទៃពោះ។ នៅពេលដែលរាងកាយម្ចាស់ខ្សោយ អាបនឹងស្វែងរកស្ត្រីវ័យក្មេងម្នាក់ទៀត ដើម្បីបន្តវដ្តនៃភាពភ័យរន្ធត់នេះ។",
  ...
  },
  {
    ...
    story: "ព្រាយ គឺជាប្រភេទបិសាច ឬព្រលឹងស្រ្តីសងសឹកដ៏គួរឲ្យភ័យខ្លាច ដែលកើតចេញពីសោកនាដកម្ម ដូចជាស្រ្តីដែលស្លាប់ដោយគ្រោះថ្នាក់សាហាវ ឬស្លាប់ពេលសម្រាលកូន (ព្រាយក្រឡាភ្លើង)។ ពួកគេល្បីខាងចាំយាមទឹកដី ដើមឈើបុរាណ ឬលងបន្លាចតាមផ្លូវបំបែក ដោយចាំឆក់យកជីវិត ឬបង្កជំងឺសាហាវភ្លាមៗដល់អ្នកដំណើរដែលមិនបានប្រុងប្រយ័ត្ន។",
  ...
  },
  {
    ...
    place: "ព្រៃអារក្ស ដើមជ្រៃ ឬដើមរកាធំៗបុរាណ ប្រភពទឹក ភ្នំ វាលស្រែ និងអាសនៈសក្ការៈ នៅតាមជនបទក្នុងប្រទេសកម្ពុជា។",
    media: arakImg
  },
  {
    id: 7,
